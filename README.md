...
```
docker build -t mosheblumberg/mosheblumbergansible:ansible2.147CP7.6.1 .
```
...
```
docker run --name cpansible -it mosheblumberg/mosheblumbergansible:ansible2.147CP7.6.1
ansible --version
```
...
```
docker login
docker push mosheblumberg/mosheblumbergansible:ansible2.147CP7.6.1
...
Scan image  
```
 docker scan mosheblumberg/mosheblumbergansible:ansible2.147CP7.6.1
```
...
docker run --name cpansible -v /tmp/myhostsfiles:/data -it mosheblumberg/mosheblumbergansible:ansible2.147CP7.6.1 
```
